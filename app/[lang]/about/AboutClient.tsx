...
// إضافة هذه الواجهة لتعريف الخصائص التي يمكن أن يستقبلها المكون
interface AboutClientProps {
  lang?: string;
}

// تمرير الخصائص إلى المكون
export default function AboutClient({ lang: propLang }: AboutClientProps) {
  const params = useParams<{ lang: string }>()

  // دمج الطريقتين: نأخذ اللغة من الخاصية (propLang) إذا كانت موجودة، وإلا نأخذها من الرابط (params.lang)
  const activeLang = propLang || params?.lang

  const safeLang = activeLang || "en"
